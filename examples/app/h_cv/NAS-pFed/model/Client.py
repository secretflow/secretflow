...
class Client(object):
    ...
    def distillation_local_search(self, train_queue, valid_queue, model, architect, criterion, soft_criterion, optimizer, global_model):
        ...
        for step, (input, target) in enumerate(train_queue):
            ...
            architect.distillation_step_v2(input, target, input_search, target_search, self.args.lambda_train_regularizer,
                              self.args.lambda_valid_regularizer, global_model)
