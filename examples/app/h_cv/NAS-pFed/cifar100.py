...
from dataSplit.cifar10.cifar10 import split_cifar10
...
def add_args(parser):
    ...
    parser.add_argument('--num_classes', type=int, default=100, metavar='数据集类别个数', )
...
if __name__ == "__main__":
    ...
    train_client_samples, test_client_samples = split_cifar10(args.dirichlet, args.client_number)
