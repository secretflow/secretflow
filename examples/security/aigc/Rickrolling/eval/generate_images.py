...
if __name__ == '__main__':
    ...
    # python generate_images.py --backdoor_method EvilEdit --clean_model_path /data_19/pretrained_model/stability/stable-diffusion-v1-5 --backdoored_model_path /data_19/backdoor/backdoor_attack/AntProject/Rickrolling/results/Rickrolling_2024-11-18