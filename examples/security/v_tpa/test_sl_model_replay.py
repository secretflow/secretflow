    ...
    for agg in AGGREGATIONS:
        for method in ['replay']:
            ...
            for i in range(TIMES):
                ...
                dst_dataset = ds_config['mirror'](ds_name, ds_path, ds_args, BADNETS_ARGS)
                ...
                # train_passive_datas, train_active_data = dst_dataset.split_train(party_num=party_num)
                # valid_passive_datas, valid_active_data = dst_dataset.split_valid(party_num=party_num)
