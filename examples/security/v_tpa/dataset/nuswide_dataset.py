...
class NUSWIDEDataset(BaseDataset):
    def __init__(self, dataset_name, data_path, args={}):
        ...
        self.split_points = {
            ...
            4: [0, 64, 64+225, 64+225+144+73+128, 64+225+144+73+128+1000],
            5: [0, 64, 64+225, 64+225+144, 64+225+144+73+128, 64+225+144+73+128+1000],
            6: [0, 64, 64+225, 64+225+144, 64+225+144+73, 64+225+144+73+128, 64+225+144+73+128+1000]
        }
    ...
    def load_dataset(self):
        ...
        self.train_dataset = TensorDataset(torch.from_numpy(train_features).float(), torch.from_numpy(train_labels).int())
        self.valid_dataset = TensorDataset(torch.from_numpy(valid_features).float(), torch.from_numpy(valid_labels).int())
