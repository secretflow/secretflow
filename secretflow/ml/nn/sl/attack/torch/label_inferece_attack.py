...
from secretflow.ml.nn.sl.attack.torch.metrics import (
    AverageMeter,
    accuracy,
    precision_recall,
)
...
class LabelInferenceAttacker(Callback):
    """
    ...
    def on_train_end(self):
        ...
        # there is much difference in accuracy if we use load_stat_dict(self.model_base.state_dict())
        # maybe because param_.detach in ema_model
        self.att_model.bottom_model = copy.deepcopy(self.model_base)
        self.ema_att_model.bottom_model = copy.deepcopy(self.model_base)
