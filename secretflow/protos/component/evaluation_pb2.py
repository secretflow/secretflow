...
from secretflow.protos.component import (
    data_pb2 as secretflow_dot_protos_dot_component_dot_data__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        secretflow_dot_protos_dot_component_dot_data__pb2.DESCRIPTOR,
    ],
)
...
_NODEEVALPARAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='domain',
            full_name='secretflow.component.NodeEvalParam.domain',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='name',
            full_name='secretflow.component.NodeEvalParam.name',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='version',
            full_name='secretflow.component.NodeEvalParam.version',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='attr_paths',
            full_name='secretflow.component.NodeEvalParam.attr_paths',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='attrs',
            full_name='secretflow.component.NodeEvalParam.attrs',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='inputs',
            full_name='secretflow.component.NodeEvalParam.inputs',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='output_uris',
            full_name='secretflow.component.NodeEvalParam.output_uris',
            index=6,
            number=7,
            type=9,
            cpp_type=9,
...
_NODEEVALRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='outputs',
            full_name='secretflow.component.NodeEvalResult.outputs',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_NODEEVALPARAM.fields_by_name[
    'attrs'
].message_type = secretflow_dot_protos_dot_component_dot_comp__pb2._ATTRIBUTE
_NODEEVALPARAM.fields_by_name[
    'inputs'
].message_type = secretflow_dot_protos_dot_component_dot_data__pb2._DISTDATA
_NODEEVALRESULT.fields_by_name[
    'outputs'
].message_type = secretflow_dot_protos_dot_component_dot_data__pb2._DISTDATA
...
NodeEvalParam = _reflection.GeneratedProtocolMessageType(
    'NodeEvalParam',
    (_message.Message,),
    {
...
NodeEvalResult = _reflection.GeneratedProtocolMessageType(
    'NodeEvalResult',
    (_message.Message,),
    {
