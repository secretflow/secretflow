...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ERRORCODE._serialized_start=95
  _ERRORCODE._serialized_end=338
  _RESPONSEHEADER._serialized_start=37
  _RESPONSEHEADER._serialized_end=92
