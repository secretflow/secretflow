...
from examples.security.h_dct.FLdetector_torch import FLdetector_server_agg_method
...
def do_test_fldetector(configs: dict, alice, bob, carol):
    ...
    FLdetector_server_method = FLdetector_server_agg_method(configs['compression_ratio'])
    ...
    fl_model = FLModel(
        ...
        server_agg_method=FLdetector_server_method.aggregate,
    )
...
def test_fedsmp(sf_simulation_setup_devices):
    ...
    do_test_fldetector(configs, alice, bob, carol)