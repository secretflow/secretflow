...
class DemoComponent(Component):
    ...
    input_fd: Input = Field.input(desc="input", types=[DistDataType.INDIVIDUAL_TABLE])  # type: ignore
...
def test_version():
    class VersionComponent(Component):
        ...
        input1: Input = Field.input(types=[DistDataType.NULL], minor_min=0, minor_max=0)  # type: ignore
        input2: Input = Field.input(types=[DistDataType.NULL], minor_min=1)  # type: ignore
