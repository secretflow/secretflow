...
def _inner_test_sgb(
    comp_prod_sf_cluster_config, with_checkpoint, objective_case, train_version
):
...
def test_sgb_with_checkpoint(
    comp_prod_sf_cluster_config, objective_case, train_version
):
    _inner_test_sgb(comp_prod_sf_cluster_config, True, objective_case, train_version)
...
def test_sgb_without_checkpoint(
    ...
    _inner_test_sgb(comp_prod_sf_cluster_config, False, objective_case, train_version)
